...
{
	ThreadConditionSignalEvent::ThreadConditionSignalEvent()
	{
#ifdef _WIN32
	...
	void ThreadConditionSignalEvent::Close(void)
	{
#ifdef _WIN32
	...
	void ThreadConditionSignalEvent::TriggerEvent(void)
	{
#ifdef _WIN32
		SetEvent(eventList);
#else
	...
	void ThreadConditionSignalEvent::WaitEvent(int timeoutMs)
	{
#ifdef _WIN32
	...
	void JACKIE_INET::ThreadConditionSignalEvent::Init(void)
	{
